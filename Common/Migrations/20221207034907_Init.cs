        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vicious = table.Column<uint>(type: "int unsigned", nullable: false),
                    UpgradesAvailable = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    UpgradesApplied = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    NameTag = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CanGrow = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    GrowthLevel = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    GrowthExperience = table.Column<uint>(type: "int unsigned", nullable: false),
                    Durability = table.Column<uint>(type: "int unsigned", nullable: false),
                    Potential = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    Enchantments = table.Column<byte>(type: "tinyint unsigned", nullable: false),
                    FirstPotential = table.Column<ushort>(type: "smallint unsigned", nullable: false),
                    SecondPotential = table.Column<ushort>(type: "smallint unsigned", nullable: false),
                    ThirdPotential = table.Column<ushort>(type: "smallint unsigned", nullable: false),
                    FirstSocket = table.Column<ushort>(type: "smallint unsigned", nullable: false),
                    SecondSocket = table.Column<ushort>(type: "smallint unsigned", nullable: false),
                    ...
                    Attribute = table.Column<ushort>(type: "smallint unsigned", nullable: false),
